 ...
 * </pre>
 * 功能是完成类的筛选，条件可以是：
 * 1. 类是否是某个接口或者类的子类 isA
 * 2. 类是否具有某个注解：AnnotatedWith
 *
...
public class ResolverUtil<T> {
    ...
    /**
     * 两个判断功能的父接口，有两个实现：IsA类、AnnotatedWith类
     ...
     * {@link #getClasses()}.
     *
     * @param test        an instance of {@link Test} that will be used to filter classes 测试条件 IsA or AnnotatedWith
     * @param packageName the name of the package from which to start scanning for classes, e.g. {@code net.sourceforge.stripes} 路径
     * @return the resolver util 本身
     */
...
//        // 列出的内容包括嵌套子级
//        List<String> list = VFS.getInstance().list("com/chenx/learning");

 ...
 * 提供了直接运行sql的功能
 * 使用示例{@link com.chenx.learning.jdbc.SqlRunnerTest}
 */
public class SqlRunner {
     ...
     * selectOne本质就是调用selectAll，然后判断查询结果是否只有一条。
     *
     * @param sql  The SQL
     ...
     * 执行一个select语句，有多个查询结果
     *
     * @param sql  The SQL  sql语句字符串
     * @param args The arguments to be set on the statement. 替换 ? 占位符的参数，如果是null，要使用本包下的Null类中的枚举值，以明确参数的类型
     * @return The list of rows expected. 结果列表
